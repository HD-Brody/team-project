...
import application.port.incoming.UploadSyllabusUseCase;
import application.port.outgoing.AiExtractionPort;
import application.port.outgoing.PdfExtractionPort;
import application.port.outgoing.SyllabusParsingPort;
import application.port.outgoing.TransactionalPersistencePort;
import domain.repository.AssessmentRepository;
import domain.repository.CourseRepository;
import domain.repository.MarkingSchemeRepository;
import domain.repository.SyllabusRepository;
