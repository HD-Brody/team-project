...
class IcsCalendarRendererTest {
    ...
    void rendersValidIcsFile() throws Exception {
        ...
        ScheduleEvent event = new ScheduleEvent(
                ...
                Instant.parse("2026-03-10T15:00:00Z").toString(),
                Instant.parse("2026-03-10T16:00:00Z").toString(),
                "BA 2135",
    ...
    void writesFixtureFileForManualInspection() throws Exception {
        ...
        ScheduleEvent event = new ScheduleEvent(
                ...
                "user-99",
                "Fixture Event",
                Instant.parse("2026-04-01T12:00:00Z").toString(),
                Instant.parse("2026-04-01T13:00:00Z").toString(),
                "BA 2000",
