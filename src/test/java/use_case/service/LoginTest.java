...
public class LoginTest {
    ...
    void setup() {
        ...
        loginInteractor = new LoginInteractor(userRepository, sessionStorage, loginPresenter);
    ...
    void LoginServiceExecuteSuccessTest() {
        loginInteractor.execute(new LoginInputData("123@abc.com", "123"));
        assertTrue(loginPresenter.getSuccessCalled());
    }

    @Test
    void LoginServiceExecuteFailTest() {
        loginInteractor.execute(new LoginInputData("12111111113@abc.com", "123"));
    ...
    void LoginServiceExecutePwdDontMatchTest() {
        loginInteractor.execute(new LoginInputData("123@abc.com", "123213123"));
        assertFalse(loginPresenter.getSuccessCalled());
    ...
    void LoginServiceExecutePwdEmptyTest() {
        loginInteractor.execute(new LoginInputData("123@abc.com", null));
        assertFalse(loginPresenter.getSuccessCalled());
    ...
    void LoginServiceSwitchViewTest() {
        loginInteractor.switchView("welcome");
