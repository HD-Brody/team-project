...
class GradeCalculationServiceTest {
    ...
    void handlesNoAssessments() {
        GradeCalculationResponse response = calculate(List.of(), 0);
    ...
    void calculatesWhenAllGradesPresent() {
        ...
        GradeCalculationResponse response = calculate(assessments, 0);
    ...
    void calculatesRequiredAverageForRemainingAssessments() {
        ...
        GradeCalculationResponse response = calculate(assessments, 80);
    ...
    void targetExactlyAtPerfectScores() {
        ...
        GradeCalculationResponse response = calculate(assessments, 90);
    ...
    void identifiesTargetAsGuaranteedWhenNegativeAverageNeeded() {
        ...
        GradeCalculationResponse response = calculate(assessments, 60);
    ...
    private GradeCalculationResponse calculate(List<Assessment> assessments, double targetPercent) {
        GradeCalculationService service = new GradeCalculationService(assessments);
        GradeCalculationRequest request = new GradeCalculationRequest("CSC207", "user-1", targetPercent, assessments);
